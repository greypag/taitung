...
class acf_field_google_map_extended_v5 extends acf_field_google_map_extended {
  ...
  */
  function input_admin_enqueue_scripts() {
    wp_register_script("googlemaps-api", "//maps.googleapis.com/maps/api/js?v=3&key=AIzaSyAmOb-FF8nFDQtZmZVSsZzq8sGpWXnd7jU&sensor=false&libraries=places",array(),'3',false);
