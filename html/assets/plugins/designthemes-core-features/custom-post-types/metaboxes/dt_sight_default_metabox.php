...
<div class="custom-box meta-fields">
    ...
    <div class="column one-fourth">
        <?php $v = array_key_exists("client",$sight_settings) ?  $sight_settings['client'] : '';?>
    ...
    <div class="column one-fourth">
        <?php $v = array_key_exists("location",$sight_settings) ?  $sight_settings['location'] : '';?>
    ...
    <div class="column one-fourth last">
        <?php $v = array_key_exists("url",$sight_settings) ?  $sight_settings['url'] : '';?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="image-preview-container">
            <?php $subtitlebg = array_key_exists ( "sub-title-bg", $sight_settings ) ? $sight_settings ['sub-title-bg'] : '';?>
...
<div class="sub-title custom-box">
    ...
    <div class="column five-sixth last">
        <div class="column one-third">
            ...
            <?php $bgrepeat =  array_key_exists ( "sub-title-bg-repeat", $sight_settings ) ? $sight_settings ['sub-title-bg-repeat'] : ''; ?>
            <div class="clear"></div>
        ...
        <div class="column one-third">
            ...
            <?php $bgposition =  array_key_exists ( "sub-title-bg-position", $sight_settings ) ? $sight_settings ['sub-title-bg-position'] : ''; ?>
            <div class="clear"></div>
        ...
        <?php $label = 		__("Background Color",'dt_themes');
              ...
              $value =  	array_key_exists ( "sub-title-bg-color", $sight_settings ) ? $sight_settings ['sub-title-bg-color'] : "#";
...
<div class="custom-box ">
	...
	<div class="column five-sixth last">
		...
		$layouts = array (
				'single-sight-layout-one' => 'sight-fullwidth',
				'single-sight-layout-two' => 'sight-with-left-sight',
				'single-sight-layout-three' => 'sight-with-right-sight'
		);

		$v = array_key_exists ( "layout", $sight_settings ) ? $sight_settings ['layout'] : 'single-sight-layout-one';
		foreach ( $layouts as $key => $value ) {
			$class = ($key == $v) ? " class='selected' " : "";
			echo "<li><a href='#' rel='{$key}' {$class}><img src='" . plugin_dir_url ( __FILE__ ) . "images/columns/{$value}.png' /></a></li>";
		}
		?></ul>
		<?php $v = array_key_exists("layout",$sight_settings) ? $sight_settings['layout'] : 'single-sight-layout-one';?>
		<input id="mytheme-sight-layout" name="layout" type="hidden"
			value="<?php echo $v;?>" />
...
<div class="custom-box">
	...
	$switchclass = array_key_exists ( "show-related-items", $sight_settings ) ? 'checkbox-switch-on' : 'checkbox-switch-off';
	$checked = array_key_exists ( "show-related-items", $sight_settings ) ? ' checked="checked"' : '';
...
<div class="custom-box">
	...
	<div class="column five-sixth last"><?php
	$switchclass = array_key_exists ( "show-social-share", $sight_settings ) ? 'checkbox-switch-on' : 'checkbox-switch-off';
	$checked = array_key_exists ( "show-social-share", $sight_settings ) ? ' checked="checked"' : '';
...
<div class="custom-box">
	...
	<div class="column five-sixth last"><?php
	$switchclass = array_key_exists ( "comment", $sight_settings ) ? 'checkbox-switch-on' : 'checkbox-switch-off';
	$checked = array_key_exists ( "comment", $sight_settings ) ? ' checked="checked"' : '';

	?><div data-for="mytheme-sight-comment"
			class="dt-checkbox-switch <?php echo $switchclass;?>"></div>

		<input id="mytheme-sight-comment" class="hidden" type="checkbox"
			name="mytheme-sight-comment" value="true" <?php echo $checked;?> />
...
<div class="custom-box">
	...
	<div class="column five-sixth last">
		...
		<div class="dt-media-container">
			...
			if (array_key_exists ( "items", $sight_settings )) {
				foreach ( $sight_settings ["items_thumbnail"] as $key => $thumbnail ) {
					$item = $sight_settings ['items'] [$key];
					$out = "";
					$name = "";
					$foramts = array (
							'jpg',
					...
					if (in_array ( $ext, $foramts )) {
						$name = $sight_settings ['items_name'] [$key];
						$out .= "<li>";
