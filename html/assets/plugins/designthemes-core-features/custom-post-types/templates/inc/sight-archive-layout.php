<?php
	...
	$page_layout = dt_theme_option('specialty', 'sight-archives-layout');
	if($GLOBALS['force_enable'] == true)
	  $page_layout = $GLOBALS['page_layout'];
	else
	  $page_layout = !empty($meta_set['layout']) ? $meta_set['layout'] : $GLOBALS['page_layout'];

	$post_layout = dt_theme_option('specialty', 'sight-archives-post-layout');
	...
	switch($post_layout) {
		case "one-column":
			$li_class = "portfolio dt-sc-one-half column"; $feature_image = "sight-twocol"; break;

		case "one-half-column":
			$li_class = "portfolio dt-sc-one-half column"; $feature_image = "sight-twocol"; break;

		case "one-third-column":
			$li_class = "portfolio dt-sc-one-third column"; $feature_image = "sight-threecol"; break;

		case "one-fourth-column":
			$li_class = "portfolio dt-sc-one-fourth column"; $feature_image = "sight-fourcol"; break;
	}
	//BETTER IMAGE SIZE...
	switch($page_layout) {
                  ...
                  <div class="fig-content-wrapper">
                    <div class="fig-content">
                        ...
                        <div class="fig-overlay">
                            <a class="zoom" title="<?php the_title(); ?>" data-gal="prettyPhoto[sight]" href="<?php echo $currenturl; ?>"><span class="fa <?php echo $currenticon; ?>"> </span></a>
