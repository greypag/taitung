...
?>
    <div class="sight-slider-container dt-sc-two-third column<?php if($page_layout == "single-sight-layout-three") echo ' right-sight'; else echo ' first'; ?>">
        ...
        <div id="entry-sight-pager">
				<?php
				$i = 0;
        $sight_pager_out='';
				foreach($p_meta_set['items'] as $key => $item){
					$sight_pager_out.="<a data-slide-index='".$i."' href='' ><img src='".$item."' alt='".$p_meta_set ['items_name'] [$key]."'></a>";
					$i += 1;
				}
        $sight_pager_out.='';
        echo $sight_pager_out;
				?></div>
		</div>
    <div class="dt-sc-one-third column<?php if($page_layout == "single-sight-layout-three") echo ' first'; ?>">
        <div class="content-box">
            ...
            <?php if(isset($p_meta_set['show-social-share'])): ?><div class="sight-share"><?php dt_theme_social_bookmarks('sb-sight'); ?></div><?php endif; ?>
        </div>
      </div>
    <!-- end: sight-single-layout-two -->
