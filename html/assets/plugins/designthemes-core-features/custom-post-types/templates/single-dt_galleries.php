...
<?php endif; ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class('fullwidth-section'); ?>>
      ...
      <div class="container clearfix">
          ...
          font-weight: 400;
				...
				$gmap_api_key='AIzaSyAmOb-FF8nFDQtZmZVSsZzq8sGpWXnd7jU';
				...
				*/
				...
				// leon let center_map function execute once
				var executed;
		...
		if(isset($meta_set['show-related-items']) != ""):
			...
			$args = array('orderby' =>	'rand', 'post_type' => 'dt_galleries', 'post__not_in' => array(get_the_ID()), 'posts_per_page' => 6);
...
<div class="fullwidth"><div class="target-gallery"></div></div>
<?php endwhile; ?>
<script type="text/javascript">
...
jQuery('.gallery-container').detach().prependTo('.target-gallery');
</script>
<!-- <?php if(isset($p_meta_set['location'])){ ?>
	<script>
	function gMap() {
