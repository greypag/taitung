		...
		if( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ){
			...
			switch( $_REQUEST['data']['import'] ) {
				...
				case 'all':
					...
					$this->import_content( $import_demo.'/content/rooms.xml.gz' );
					$this->import_content( $import_demo.'/content/hotels.xml.gz' );
					$this->import_content( $import_demo.'/content/places.xml.gz' );
					$this->import_content( $import_demo.'/content/packages.xml.gz' );
...
$dtthemes_import = new trendytravel_import;
