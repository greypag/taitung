...
*/
	...
	while(have_posts()): the_post();
	  ...
	  $default_width = !empty($meta_set['sight-fullwidth']) ? $meta_set['sight-fullwidth'] : '';
		  ...
		  <?php if($page_layout == 'with-left-sidebar' && $default_width == 'true'): ?>
			  ...
			  <?php endif; ?>
					  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div id="ajax_load_sight_container" class="fullwidth-section">
						<?php
						  the_content();
						  ...
						  get_template_part('includes/sight-post-layout');
