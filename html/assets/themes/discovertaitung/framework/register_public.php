...
function dt_theme_enqueue_scripts() {
	...
	wp_enqueue_script('jq.stickynav', $template_uri.'/js/public/jquery.sticky-kit.min.js', array(), false, true);
	// wp_enqueue_script('jq.stickynav', $template_uri.'/js/public/sticky.min.js', array(), false, true);
	...
	if(is_singular('dt_hotels') || is_singular('dt_places')):
		...
		$mapurl = add_query_arg( $args, '//maps.google.cn/maps/api/js' );
