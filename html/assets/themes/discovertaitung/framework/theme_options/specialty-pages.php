...
<div id="specialty-pages" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
         ...
         <?php $sub_menus = array(
          ...
          array("title"=>__("Sight Archives",'iamd_text_domain'), "link"=>"#sight-archives"),
        ...
        array(  "id"=>"sight-archives",
           "layout-title"=>__("Sight Custom Post's Archive Page Layout",'iamd_text_domain'),
           "layout-tooltip"=>__("You can choose between a left, right or no sidebar layout for the Gallery custom post's Archive page.",'iamd_text_domain'),
           "post-layout-title" => __("Posts Layout",'iamd_text_domain'),
           "post-layout-tooltip"=>__("Your archive results will use the layout you select below.",'iamd_text_domain'),
           "post-layouts" => array(
             'one-column'=>__("Single sight item  per row.",'iamd_text_domain'),
             'one-half-column'=>__("Two sight items per row.",'iamd_text_domain'),
             'one-third-column'=>__("Three sight items per row.",'iamd_text_domain'),
             'one-fourth-column' => __("Three sight items per row.",'iamd_text_domain'))
       ),
